...
class StackedLstmModel(BaseModel):
    """
    A Stacked LSTM Forecasting Model.
    """
    def __init__(self, params=None):
        ...
        super().__init__("Stacked LSTM", params)
    ...
    def _build_model(self, input_shape):
        ...
        # Layer 1:
        model.add(LSTM(
            units=self.params['lstm_units_1'],
            activation='relu',
        ...
        # Layer 2:
        model.add(LSTM(units=self.params['lstm_units_2'], activation='relu'))
        model.add(Dropout(self.params['dropout_rate']))

        # Output Layer: A single neuron for predicting the price.
